                    ...
                    <div class="fxt-bg-img">
                        <div class="fxt-header">
                            <div class=" wow fadeInRight">
                                <a href="index.php" class="fxt-logo"><img src="assets/img/images/logo/logo01.png" alt="Logo"></a>
                            </div>
                            <div class="wow fadeInUp" data-wow-delay="400ms">
                                <h1>Enter Email Address</h1>
                            </div>
                            <div class="wow fadeInUp" data-wow-delay="800ms">
                                <p> Insert Email to proceed</p>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-12 order-md-1 fxt-bg-color">
                    <div class="fxt-content">
                        ...
                        <div class="fxt-form">
                            <form method="POST">
                                <div class="form-group">  
                                    ...
                                    <input type="email" id="email" class="form-control" name="email" placeholder="email@gmail.com" required="required">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="text-center">
                            <p>Don't have an account?<a href="register-users.php" class="switcher-text">Register</a></p>
                        </div>                            
                    </div>
                </div>
            </div>
