              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <span class="text-nowrap">Current Followers</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Flagged Reviews</h5>
                  ...
                  <p class="mt-3 mb-0 text-sm">
                    ...
                    <span class="text-nowrap">All Flagged Reviews</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Review Performance</h6>
                  <h5 class="h3 mb-0">Average Perfomance</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
