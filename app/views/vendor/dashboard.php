...
<head>
  ...
  <title>ChecknCommit: Business Name - <?=$data['title']?></title>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              ...
              <div class="collapse show" id="navbar-dashboards">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="vendor/index" class="nav-link">
            ...
            <li class="nav-item">
              <a class="nav-link" href="vendor/followers">
            ...
            <li class="nav-item">
              <a class="nav-link" href="vendor/subscription">
                <i class="ni ni-ungroup text-green"></i>
              ...
              <a class="nav-link pr-0" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Business Name</span>
                  </div>
                </div>
              </a>
