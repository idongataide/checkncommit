...
<head> 
    ...
    <title>ChecknCommit - Your Online Reviewing Platform</title>
    ...
    .vertical-nav-menu li a:hover {        
        ...
        .app-header .app-header__content,.fixed-header .app-header .app-header__logo  {
            background:#f7b924
       }
                ...
                <div class="app-header__menu">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-rocket"></i> View Users
                            ...
                            <li>
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-rocket"></i> Business Categories
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="index-2.html">
                                            <i class="metismenu-icon"></i>Add Categories
                                        </a>
                                    </li>
                                    <li>
                                        <a href="businesses" >
                                            <i class="metismenu-icon"></i>View All Categories
                                        </a>
                                    </li>                                                            
                                </ul>
                            </li>
