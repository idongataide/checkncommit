...
<div class="hero-wrap img" style="background-image: url(public/images/hero_area/bg_1.jpg);background-size:cover">
...
<div class="icon mr-2">
<span class="flat flaticon-worldwide"></span>
</div>
<div class="desc text-left">
<strong class="number" data-number="46">46+</strong>
...
<div class="text d-flex">
<div class="icon mr-2">
<span class="flat flaticon-resume"></span>
</div>
<div class="desc text-left">
...
<div class="ftco-search my-md-5 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="600ms">
<div class="row">
<div class="col-md-12 nav-link-wrap">
<div class="nav nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
<a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">Search For Business</a>
</div>
</div>
<div class="col-md-12 tab-wrap mb-4">
...
<div class="mx-auto">
    ...
    <section id="ts-speakers" class="ts-speakers speaker-classic" style="background-image:url(public/images/speakers/speaker_bg.png)">
         ...
         <div class="speaker-shap">
            <img class="shap1" src="public/images/shap/home_speaker_memphis1.png" alt="">
            <img class="shap2" src="public/images/shap/home_speaker_memphis2.png" alt="">
            ...
            <div class="row">
               <div class="col-lg-12">
                  <h2 class="section-title white">
                    ...
                    Subscribe to our Business Plan
                  </h2>
