            ...
            <div class="container">
                <div class="bottom-wrap">
                    <div class="bottom-inside d-md-flex justify-content-md-between align-items-center">
                        ...
                        <div class="address">Hardensoft Limited</div>
                        <div class="logo-footer">
                            <a href="index-2.html"><img src="public/assets/img/images/logo/logo01.png" alt="images"></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <!-- slider -->
    <script src="public/assets/rev-slider/js/jquery.themepunch.tools.min.js"></script>
    <script src="public/assets/rev-slider/js/jquery.themepunch.revolution.min.js"></script>
